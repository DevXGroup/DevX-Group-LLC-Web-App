        ...
        <div className="container mx-auto relative z-10 max-w-full px-4 sm:px-6 lg:px-8 pt-8 pb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1 xl:col-span-1 flex flex-col">
              ...
              <p className="text-sm text-zinc-400 mb-6 max-w-sm leading-relaxed font-light">
          ...
          <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-border">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:flex lg:items-center gap-4 lg:gap-8 text-sm text-zinc-400">
                <a
          ...
          <div className="mt-6 lg:mt-10 border-t border-border py-6 pb-8 flex flex-col sm:flex-row justify-center items-center gap-4 text-xs text-zinc-400">
            <p className="text-center flex items-center leading-none">
              © {new Date().getFullYear()} DevX Group LLC. All rights reserved.
            </p>
            <span className="hidden sm:block">•</span>
            <p className="text-center sm:text-left">v{version}</p>
          </div>
        </div>
      </footer>
    </>
