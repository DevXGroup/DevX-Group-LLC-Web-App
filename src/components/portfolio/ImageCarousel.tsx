    ...
    <div className="space-y-4">
      ...
      <div className="relative w-full">
        <div className="relative w-full flex items-center justify-center">
          ...
          {/* Stable fixed-ratio container — no layout shifts */}
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden bg-neutral-900 border border-white/5">
            <AnimatePresence
              initial={false}
              custom={direction}
              mode="popLayout"
            ...
            >
              <motion.div
                ...
                onDragEnd={(_, { offset, velocity }) => {
                  ...
                  if (swipe < -swipeConfidenceThreshold) goToNext()
                  else if (swipe > swipeConfidenceThreshold) goToPrevious()
                }}
              >
                {currentImage && (
                  <Image
