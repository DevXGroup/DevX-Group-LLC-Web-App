    ...
    <AnimatePresence mode="wait">
      {isOpen && project && (
        <>
          ...
          {/* Modal Container — single scroll context, iOS-safe */}
          <div
          ...
          >
            <div className="flex min-h-full items-start justify-center p-4 sm:p-6 pt-6 sm:pt-12">
              <motion.div
                variants={modalVariants}
                initial="hidden"
                animate="visible"
                exit="exit"
                className="relative w-full max-w-6xl bg-black/90 backdrop-blur-xl border border-white/20 rounded-3xl overflow-hidden mb-8"
              ...
              >
                ...
                <div className="relative h-72 sm:h-80">
                  ...
                  {/* Close Button — absolute within header, always tappable */}
                  <motion.button
                    onClick={onClose}
                    className="absolute top-4 right-4 p-3 rounded-full bg-black/80 backdrop-blur-md border-2 border-white/80 text-white hover:bg-red-600/80 transition-all duration-300 z-[100] shadow-2xl cursor-pointer"
                    whileHover={{
                      scale: 1.1,
