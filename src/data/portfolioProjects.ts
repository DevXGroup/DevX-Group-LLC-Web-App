...
export const portfolioProjects: ProjectData[] = [
  ...
  },
  {
    ...
    images: {
      ...
      preview: '/images/portfolio/screenshots/nutrify-ai/today.png',
      bannerAlt: 'Nutrify.AI today activity dashboard with AI health brief and daily action items',
      previewAlt: 'Nutrify.AI My Day dashboard with streak, actions, and health widgets',
      screenshots: [
        '/images/portfolio/screenshots/nutrify-ai/today.png',
        '/images/portfolio/screenshots/nutrify-ai/labs.png',
        '/images/portfolio/screenshots/nutrify-ai/chat.png',
        '/images/portfolio/screenshots/nutrify-ai/settings.png',
        '/images/portfolio/screenshots/nutrify-ai/components.png',
        '/images/portfolio/screenshots/nutrify-ai/splash.png',
        '/images/portfolio/screenshots/nutrify-ai/onboarding.png',
        '/images/portfolio/screenshots/nutrify-ai/auth.png',
      ],
      screenshotAlts: [
        'My Day dashboard with streak tracker, daily actions, and personalized guidance cards',
        'Nutrition and labs-focused dashboard with macro progress and meal planning',
        'AI assistant and sleep analysis experience with contextual health insights',
        'Exercise planner and workout session tracking in the emerald UI theme',
        'Workout plan details with sets, reps, and in-progress timer controls',
