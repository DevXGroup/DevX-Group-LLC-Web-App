...
export const portfolioProjects: ProjectData[] = [
  ...
  {
    id: 'transcribr',
    title: 'Transcribr — Private AI Transcription for macOS',
    shortDescription:
      'Drop any audio or video file, hit record, or paste a YouTube link. Transcribr turns it into accurate, timestamped text in seconds — all on your Mac, nothing leaves your machine.',
    detailedDescription:
      'Transcribr is a native macOS app that brings powerful AI transcription to your desktop without any cloud dependency. Everything runs locally using Whisper-based models — your audio, your transcripts, your privacy.\n\nDrop an MP4, MOV, MP3, WAV, M4A, FLAC, or WebM file, record live audio with the built-in recorder, or paste a YouTube, Instagram, or TikTok URL to pull audio directly from the web. Transcribr handles it all.\n\nThe model selector lets you pick the right speed/accuracy tradeoff — Tiny (77MB) for near-instant results, Base (147MB) for most use cases, Small (486MB) for high accuracy, or the advanced models for professional-grade output. Auto-language detection covers English, Spanish, French, German, Italian, Portuguese, Chinese, Japanese, Korean, Arabic, Hindi, Russian, Dutch, Polish, Turkish, Persian, and more.\n\nThe Ollama Cleanup toggle routes your transcript through a locally-running LLM (Gemma4 by default) for grammar fixes, filler-word removal, and a clean final output — still 100% offline. Results can be exported with or without timestamps, copied to clipboard, or remixed with AI. A system-wide Dictation Shortcut (Hold Ctrl by default) means you can trigger recording from any app.',
    category: 'macOS App',
    services: ['Custom Software Development', 'AI & Machine Learning', 'Mobile App Development'],
    technologies: ['Swift', 'SwiftUI', 'Whisper', 'Ollama', 'Core Audio', 'AVFoundation', 'yt-dlp'],
    platforms: ['macOS'],
    keyFeatures: [
      'Fully offline — no data leaves your machine, ever',
      'Drag-and-drop transcription for MP4, MOV, MP3, WAV, M4A, FLAC, WebM',
      'Live recording with real-time transcription display',
      'YouTube, Instagram, and TikTok URL import',
      'Four model tiers: Tiny (77MB) to advanced for speed vs. accuracy control',
      'Auto language detection across 15+ languages',
      'Ollama LLM cleanup — local grammar correction and filler-word removal',
      'Timestamped transcript segments with export and copy options',
      'System-wide dictation shortcut for use across any app',
      'Remix with AI — further refine transcripts without leaving the app',
    ],
    images: {
    ...
    currentNote: 'Available on Mac App Store',
    metrics: {
      users: '100% local — zero cloud dependency',
      performance: 'Whisper + Ollama on-device AI',
      marketPosition: 'Privacy-first macOS transcription',
    },
    businessImpact:
      "Transcribr shows DevX Group's ability to ship polished, production native macOS apps with sophisticated on-device AI — Whisper for transcription and Ollama for LLM cleanup — while keeping user privacy non-negotiable.",
    completionYear: '2025',
    ...
    highlights: [
      ...
      'Whisper AI with 4 model tiers for speed vs. accuracy',
      'Live recording + YouTube/Instagram/TikTok import',
      'Ollama LLM cleanup for grammar-perfect output',
    ],
  },
  {
    id: 'miremadi',
