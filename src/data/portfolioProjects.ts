...
export const portfolioProjects: ProjectData[] = [
  {
    ...
    images: {
      banner: '/images/portfolio/screenshots/nutrify-ai/myday.webp',
      preview: '/images/portfolio/screenshots/nutrify-ai/labs.webp',
      bannerAlt:
        'Nutrify.AI My Day dashboard with daily progress ring, quick links to Labs and Supplements, and Nightly Actions',
      previewAlt:
        'Nutrify.AI Labs & Biomarkers screen showing LDL, MCV and Albumin against reference ranges',
      screenshots: [
        '/images/portfolio/screenshots/nutrify-ai/myday.webp',
        '/images/portfolio/screenshots/nutrify-ai/labs.webp',
        '/images/portfolio/screenshots/nutrify-ai/chat.webp',
        '/images/portfolio/screenshots/nutrify-ai/nutrition.webp',
        '/images/portfolio/screenshots/nutrify-ai/sleep.webp',
        '/images/portfolio/screenshots/nutrify-ai/exercise.webp',
        '/images/portfolio/screenshots/nutrify-ai/supplements.webp',
        '/images/portfolio/screenshots/nutrify-ai/mealplan.webp',
      ],
      screenshotAlts: [
        'My Day dashboard: progress ring, quick links to Labs, Supplements and Meal Plan, plus Nightly Actions',
        'Labs & Biomarkers: LDL Peak Size, MCV, Albumin and RBC plotted against clinical reference ranges',
        'Chat with Nutrify, the in-app AI health coach answering questions about nutrition, sleep and labs',
        'Nutrition tab: today’s macros donut, AI Meal Plan link and per-meal calorie breakdown',
        'Sleep tab: 7-day duration and quality charts with AI Sleep Analysis summary',
        'Exercise tab: start workout, AI plan tile and weekly workout schedule',
        'Supplements stack: Chromium Picolinate, BOSS Mode 10-in-1 and Omega-3 Fatty Acids with dosing notes',
        'AI Meal Plan: 7-day plan with per-day macros and logged meals',
      ],
    },
